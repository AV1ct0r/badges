...
5. Анализ UART-траффика, записанного логическим анализатором и алгоритма генерации ссылки для telegram-активации бейджа будет во второй части ;)

6. В архиве <b>[firmware](/offzone2022/firmware.rar "firmware")</b> находятся файлы оригинальной, патченой прошивок, а также SystemMemory моего бейджа. Но архив стоит пароль в виде ID еще одного бейджа в системе ( [0-9a-f]{24} )  ;)
